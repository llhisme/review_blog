...
<div class="verdict-box">
    ...
    <!-- Link Affiliate cho lựa chọn chiến thắng -->
...
async function updateComparison() {
    ...
    try {
        ...
        `;
        await client.query(query, [comparisonContent]);
        console.log('✅ Đã cập nhật link Affiliate vào bài so sánh!');
    } catch (err) {
